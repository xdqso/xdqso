...
;   CALLING SEQUENCE:
;      loglike= xdqso_calc_loglike(ydata, ycovar, xmean, xcovar, xamp, projection=projection)
;   INPUT:
...
FUNCTION XDQSO_CALC_LOGLIKE, ydata, ycovar, xmean, xcovar, xamp, projection=projection
